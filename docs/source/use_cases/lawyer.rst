...
-----------------------------------
.. figure:: /use_cases/images/lawyer-use-scenario-diagram.png
   :width: 50%
   :align: center
   :alt: Lawyer consultation cost comparison diagram
...
.. figure:: /use_cases/images/lawyer-use-scenario-example.png
   :width: 100%
   :align: center
   :alt: Question refinement example

   LLM-generated compliance questions for investment fund usage
...
--------------------------
.. figure:: /use_cases/images/silly-user-BAF-QA-example.png
   :width: 90%
   :align: center
   :alt: Inefficient QA example

   Example of costly repetitive questioning with lawyers
